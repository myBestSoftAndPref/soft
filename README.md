Заметки переехали сюда https://gitlab.com/blog.awesomesoft/blog.awesomesoft из-за раздражающих запросов подтверждения github, которые невозможно отключить. Тут обновлений больше не будет.
