...
* RetroShare - программа для p2p имеет чаты, каналы, форум, обмен файлами, в будущем возможно видео звонки (фактически соц. сеть). Обмен происходит только с другими пользователями которым это разрешил лично пользователь (ключи GPG) https://retroshare.github.io/
