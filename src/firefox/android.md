...
- [Настройки](#Настройки)
  ...
  - [Увеличиваем максимальное число в списке недавно закрытых вкладок](#Увеличиваем-максимальное-число-в-списке-недавно-закрытых-вкладок)
  - [Отключение авто остановки видео при переключении на другое приложение](#Отключение-авто-остановки-видео-при-переключении-на-другое-приложение)
  - [Перенос длиных строк при просмотре текстовых файлов](#Перенос-длиных-строк-при-просмотре-текстовых-файлов)
