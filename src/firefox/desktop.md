Раньше тут был минимальны набор дополнений, стилей и настроек для **release** версии. К сожалению **Mozilla удалила поддержку старого API** и многие уникальные расширения перестали работать. Это вынеждает меня перейти на **ESR** ветку<sub>останусь на ней пока ситуация с **release** версией не стабилизируется</sub>, скачать [тут](https://www.mozilla.org/en-US/firefox/organizations/all/)  
