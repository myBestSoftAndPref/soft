...
- [Extensions (addons, расширения, дополнения)](#extensions-addons-расширения-дополнения)
  ...
  - [Для отдельных сайтов и сервисов](#Для-отдельных-сайтов-и-сервисов)
  ...
  - [Словари и локализации, расширения с ними](#Словари-и-локализации-расширения-с-ними)
  - [Разное](#Разное)
- [Расширения для которых НЕТ аналога в Firefox 57+ (с переходом на WebExtensions API)](#Расширения-для-которых-НЕТ-аналога-в-firefox-57-с-переходом-на-webextensions-api)
- [Программы (замена расширений, которые невозможно реализовать на WebExtensions API)](#Программы-замена-расширений-которые-невозможно-реализовать-на-webextensions-api)
...
- [Управление, горячие клавиши (hot keys)](#Управление-горячие-клавиши-hot-keys)
- [FAQ](#faq)
  - [Общие](#Общие)
    ...
    - [Расширения не работают на страницах сайта mozilla.com. Как заставить их работать на этих сайтах?](#Расширения-не-работают-на-страницах-сайта-mozillacom-Как-заставить-их-работать-на-этих-сайтах)
  ...
  - [Для Ubuntu (Debian)](#Для-ubuntu-debian)
    - [Как изменить иконку Firefox на панели? Как назначить каждому профилю Firefox свой ярлык со своей иконкой?](#Как-изменить-иконку-firefox-на-панели-Как-назначить-каждому-профилю-firefox-свой-ярлык-со-своей-иконкой)
    - [Установка и обновление Firefox не из репозитория Ubuntu, а с сайта Mozilla](#Установка-и-обновление-firefox-не-из-репозитория-ubuntu-а-с-сайта-mozilla)
    - [Установка или обновление Firefox и Thunderbird одной командой с сайта Mozilla (т.е. это установка версий Firefox и Thunderbird от Mozilla, а не от разработчиков Ubuntu)](#Установка-или-обновление-firefox-и-thunderbird-одной-командой-с-сайта-mozilla-те-это-установка-версий-firefox-и-thunderbird-от-mozilla-а-не-от-разработчиков-ubuntu)
    - [Как полностью удалить Firefox (или thunderbird)? Это может быть нужно, если вы хотите заменить Firefox из репозитория Ubuntu на версию из другого репозитория, PPA, snap, flatpak или AppImage](#Как-полностью-удалить-firefox-или-thunderbird-Это-может-быть-нужно-если-вы-хотите-заменить-firefox-из-репозитория-ubuntu-на-версию-из-другого-репозитория-ppa-snap-flatpak-или-appimage)
    - [Как использовать файловый диалог KDE в Firefox](#Как-использовать-файловый-диалог-kde-в-firefox)
...
<br>
[Tab Mix - Rename Tab](https://addons.mozilla.org/firefox/addon/tab-mix-rename-tab) - переименовывает именя табов
...
<br>
[Download Star](https://addons.mozilla.org/firefox/addon/download-star/) - может скачивать файлы в несколько потоков, но из-за ограничений Firefox скачивание файла идет внутрь профиля Firefox. **Note.** Это расширение лучше не использовать, а скачивать файлы отдельной программой.

## Пользовательские скрипты (user scripts) 
[Greasemonkey](https://addons.mozilla.org/ru/firefox/addon/greasemonkey) или [Violentmonkey](https://addons.mozilla.org/en-US/firefox/addon/violentmonkey/) - менеджер пользовательских скриптов javascript. **Violentmonkey** считается лучшим.
...
<br>
[Google search link fix](https://addons.mozilla.org/en-US/firefox/addon/google-search-link-fix/) - чистит ссылки в поисковиках Google, Yandex от переадресации (это способ сбора статистики). На деле приватность не защищает, но убирает раздражающую переадресацию и переход по ссылке станет быстрее.
<br>
