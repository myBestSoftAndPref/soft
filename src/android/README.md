...
Для обхода проблем с **2-Step Verification** привяжите другой почтовый ящик к Gmail, который не будет блокировать при входе в Gmail из другой страны, например [mail.yandex.ru](https://mail.yandex.ru). И используйте его для восстановления доступа к Gmail.
...
Используйте программу [Shelter](https://play.google.com/store/apps/details?id=net.typeblog.shelter), она создаст профиль с именем `Work` со слепком системы. Туда можнно устанавливать программы. Если профиль не нужен его можно удалить или временно приостановить.
