...
Не смотря на включенный доступ к "Ненадежные приложения" Google всеравно может запросить подтверждение телефона при входе, если посчитает, что это нужно для безопасности даже если вы отключили **2-Step Verification**. Для подтверждение телефона нужно войти в аккаунт через браузер.
