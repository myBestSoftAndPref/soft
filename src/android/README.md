...
*Предупреждение.* Если программа с открытым кодом все равно зайдите в настройки и проверьте отключена ли отправка статистики. **Внимательно** проверяйте работу сторонних таймеров, будильников etc, случаи кода производитель меняет настройки системы так что они иногда не срабатывают были и есть! <sub>(доверяйте только **родным** будильнику и таймеру)</sub>
